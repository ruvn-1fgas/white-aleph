...
/datum/computer_file/program/revelation/proc/activate()
	if(computer)
		...
		computer.visible_message(span_notice(" [computer]'s screen brightly flashes and loud electrical buzzing is heard."))
		...
		if(computer.internal_cell && prob(25))
			...
			computer.visible_message(span_notice(" [computer]'s battery explodes in rain of sparks."))
