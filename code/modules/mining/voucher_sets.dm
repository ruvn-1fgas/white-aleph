...
/datum/voucher_set/extraction_kit
	name = "Набор для эвакуации и спасения"
...
/datum/voucher_set/survival_capsule
	name = "Спасательная капсула и разгрузка исследователя"
...
/datum/voucher_set/conscription_kit
	name = "Комплект шахтера-призывника"
