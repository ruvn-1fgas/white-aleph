...
/datum/admins/Topic(href, href_list)
	...
	if(href_list["editrightsbrowsermanage"])
		...
		switch(href_list["simplemake"])
			...
			if("drone")
				M.change_mob_type( /mob/living/basic/drone , null, null, delmob )
			if("hunter")
				M.change_mob_type( /mob/living/carbon/alien/adult/hunter , null, null, delmob )
			if("queen")
				M.change_mob_type( /mob/living/carbon/alien/adult/royal/queen , null, null, delmob )
			if("praetorian")
				M.change_mob_type( /mob/living/carbon/alien/adult/royal/praetorian , null, null, delmob )
			if("sentinel")
				M.change_mob_type( /mob/living/carbon/alien/adult/sentinel , null, null, delmob )
			if("larva")
			...
			if("crab")
				M.change_mob_type( /mob/living/basic/crab , null, null, delmob )
			if("coffee")
				M.change_mob_type( /mob/living/basic/crab/coffee , null, null, delmob )
			if("parrot")
				M.change_mob_type( /mob/living/simple_animal/parrot , null, null, delmob )
			if("polyparrot")
				M.change_mob_type( /mob/living/simple_animal/parrot/poly , null, null, delmob )
			if("constructjuggernaut")
				M.change_mob_type( /mob/living/basic/construct/juggernaut , null, null, delmob )
			if("constructartificer")
				M.change_mob_type( /mob/living/basic/construct/artificer , null, null, delmob )
			if("constructwraith")
				M.change_mob_type( /mob/living/basic/construct/wraith , null, null, delmob )
			if("shade")
