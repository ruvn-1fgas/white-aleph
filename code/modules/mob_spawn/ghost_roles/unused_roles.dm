...
/obj/effect/mob_spawn/ghost_role/human/syndicatespace/captain
	...
	important_text = "Защитите корабль и секретные документы в своем рюкзаке любой ценой, даже ценой своей жизни! ЗАПРЕЩЕНО покидать корабль во избежание риска захвата его сотрудниками вражеской корпорации."
