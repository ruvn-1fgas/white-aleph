...
/datum/infuser_entry/goliath
	...
	threshold_desc = "я могу ходить по лаве!"
	qualities = list(
...
/datum/infuser_entry/carp
	name = "Карп"
	infuse_mob_name = "космический карп"
	...
	threshold_desc = "вы узнаете, как \"плавать\" в космосе"
	qualities = list(
...
/datum/infuser_entry/rat
	...
	threshold_desc = "вы становитесь настолько маленьким, что можете пролезть через вентиляцию."
	qualities = list(
...
/datum/infuser_entry/roach
	...
	threshold_desc = "вы будете невероятно устойчивы к вирусам, взрывам и радиации."
	qualities = list(
