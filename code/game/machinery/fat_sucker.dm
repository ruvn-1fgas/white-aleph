...
/obj/machinery/fat_sucker/examine(mob/user)
	. = ..()
	. += {"[span_notice("Alt-клик для разблокировки или блокировки люка.")]
				[span_notice("Удаляем [bite_size] единиц питательных веществ за операцию.")]
				[span_notice("Требует [nutrient_to_meat] единиц питательных веществ на кусок мяса.")]"}
