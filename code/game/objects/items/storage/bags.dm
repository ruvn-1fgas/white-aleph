...
/obj/item/storage/bag/ore/proc/pickup_ores(mob/living/user)
	...
	if(show_message)
		...
		if (box)
			...
			user.visible_message(
				span_notice("[user] выгружает руду под собой в [box]."),
				ignored_mobs = user
			)
		else
			balloon_alert(user, "собираю руду под собой в сумку")
			user.visible_message(
				span_notice("[user] собирает руду под собой."),
				ignored_mobs = user
			)
...
/obj/item/storage/bag/plants/portaseeder/add_context(
	...
	context[SCREENTIP_CONTEXT_CTRL_LMB] = "Создать семена"
	return CONTEXTUAL_SCREENTIP_SET


/obj/item/storage/bag/plants/portaseeder/examine(mob/user)
	. = ..()
	. += span_notice("Ctrl-клик для активации.")
...
/obj/item/storage/bag/sheetsnatcher
	...
	desc = "Сумка разработанная для шахтёров и строителей, способная хранить до 500 листов различных материалов."
	icon = 'icons/obj/mining.dmi'
...
/obj/item/storage/bag/sheetsnatcher/borg
	...
	desc = "Сумка разработанная для шахтёров и строителей, способная хранить до 1000 листов различных материалов."
...
/obj/item/storage/bag/tray/cafeteria
	...
	icon = 'icons/obj/food/containers.dmi'
	icon_state = "foodtray"
	desc = "Дешевый металлический поднос."
