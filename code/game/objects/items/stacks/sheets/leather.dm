...
/obj/item/stack/sheet/animalhide/attackby(obj/item/W, mob/user, params)
	if(W.get_sharpness())
		...
		user.visible_message(span_notice("[user] starts cutting hair off  [src]."), span_notice("You start cutting the hair off  [src]..."), span_hear("You hear the sound of a knife rubbing against flesh."))
