...
/datum/brain_trauma/severe/dyslexia
	name = "Дислексия"
	desc = "Пациент не может читать или писать."
	scan_desc = "<b>дислексии</b>"
	gain_text = span_warning("Я не могу читать или писать...")
	lose_text = span_notice("Я вдруг вспомнил как читать и писать.")
