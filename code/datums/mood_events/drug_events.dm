...
/datum/mood_event/maintenance_high
	mood_change = 6
	description = "<span class='nicegreen'>Я на вершине мира, детка!</span>\n"
	timeout = 2 MINUTES
...
/datum/mood_event/maintenance_high/add_effects(param)
	...
	mood_change = value
	if(value < 0)
		description = "<span class='warning'>Нет! Не надо! Мои перчатки! Мои перчатки!</span>\n"
	else
		description = initial(description)

/datum/mood_event/hang_over
	mood_change = -4
	description = "<span class='warning'>Голова раскалывается!</span>\n"
	timeout = 1 MINUTES
...
/datum/mood_event/hauntium_spirits
	description = "<span class='boldwarning'>Я чувствую, как моя душа разлагается!</span>\n"
	mood_change = -8
	timeout = 8 MINUTES
