...
/datum/supply_pack/engine/am_jar
	name = "Ящик с контейнером для антиматерии"
	desc = "Два контейнера с антиматерией, помещенные в один ящик."
	cost = 2000
...
/datum/supply_pack/engine/am_core
	name = "Ящик управления антиматерией"
	desc = "Это устройство, являющееся ядром двигателя на антиматерии, наверняка научит энергосистему станции понимать, что такое настоящая сила."
	cost = 5000
	contains = list(/obj/machinery/power/am_control_unit)
	crate_name = "antimatter control crate"

/datum/supply_pack/engine/am_shielding
	name = "Ящик для экранирования антиматерии"
	desc = "Содержит десять щитов антиматерии, каким-то образом втиснутых в ящик."
	cost = 2000
